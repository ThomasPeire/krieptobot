...
namespace KrieptoBot.Infrastructure.Bitvavo.Dtos
{
    public class OrderDto
    {
        ...
        [JsonProperty("amountRemaining")] public string AmountRemaining { get; set; }

        [JsonProperty("price")] public string Price { get; set; }

        [JsonProperty("amountQuote")] public string AmountQuote { get; set; }

        [JsonProperty("amountQuoteRemaining")] public string AmountQuoteRemaining { get; set; }

        [JsonProperty("onHold")] public string OnHold { get; set; }

        [JsonProperty("onHoldCurrency")] public string OnHoldCurrency { get; set; }

        [JsonProperty("triggerPrice")] public string TriggerPrice { get; set; }

        [JsonProperty("triggerAmount")] public string TriggerAmount { get; set; }

        [JsonProperty("triggerType")] public string TriggerType { get; set; }

        [JsonProperty("triggerReference")] public string TriggerReference { get; set; }

        [JsonProperty("filledAmount")] public string FilledAmount { get; set; }

        [JsonProperty("filledAmountQuote")] public string FilledAmountQuote { get; set; }

        [JsonProperty("feePaid")] public string FeePaid { get; set; }

        [JsonProperty("feeCurrency")] public string FeeCurrency { get; set; }

        [JsonProperty("fills")] public List<FillDto> Fills { get; set; }

        [JsonProperty("selfTradePrevention")] public string SelfTradePrevention { get; set; }
    ...
    public class FillDto
    {
        ...
        [JsonProperty("taker")] public bool Taker { get; set; }
